...
We also reused samples from prior reviews, as outlined in @tbl-searches.
...
|:--------|:-----------------|:----------------|
| @WagnerPresterPare2021 | [WagnerPresterPare2021_search_history.json](https://github.com/fs-ise/C5-DM-vignette/blob/main/data/search/WagnerPresterPare2021_search_history.json) | [WagnerPresterPare2021.bib](https://github.com/fs-ise/C5-DM-vignette/blob/main/data/search/WagnerPresterPare2021.bib) |
| @Fiers2023 | [Fiers2023_search_history.json](https://github.com/fs-ise/C5-DM-vignette/blob/main/data/search/Fiers2023_search_history.json) | [Fiers2023.csv](https://github.com/fs-ise/C5-DM-vignette/blob/main/data/search/Fiers2023.csv) |
...
The prisma chart is currently a screenshot (needs to be updated):
